...
DATABASES = {
    'default': {
        ...
        'NAME': 'django_blog_db',
        'USER': 'blog_user',
        'PASSWORD': 'blog_password_123',  # Change this in production
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
SECRET_KEY = 'django-insecure-wa2)(ic*i3yaji+x_&)!x+b)muv@2%j3cl2hu%ia((o8wrfo%1'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'builtins': [
                'blog.templatetags.blog_extras',  #  custom template tags 
            ],
        },
    },
]
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfile')  # for production
